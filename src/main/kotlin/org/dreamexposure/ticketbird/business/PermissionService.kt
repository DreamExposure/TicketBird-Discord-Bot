...
class PermissionService(
    ...
    fun getBotPermissionOverrides() = PermissionSet.of(
    ...
    fun getSupportChannelMemberOverrides() = PermissionSet.of(
        Permission.VIEW_CHANNEL,
        Permission.READ_MESSAGE_HISTORY,
    )
    ...
    fun hasRequiredElevatedPermissions(memberPermissions: PermissionSet) =
